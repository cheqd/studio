...
// This module is a fork of the original Short Unique ID module by.
// Fork author: @eengineer1
// Changes:
// - Removed `eval` and `new Function` calls. No false positives in V8.
const version = '4.4.4';
...
export default class ShortUniqueId {
	...
	private constructor(argOptions: Partial<ShortUniqueIdOptions> = {}) {
	...
	static instantiate = (argOptions: Partial<ShortUniqueIdOptions> = {}): ShortUniqueId => {
		return new ShortUniqueId(argOptions);
	};
}

export function shortUniqueId(argOptions: Partial<ShortUniqueIdOptions> = {}): ShortUniqueId {
	return ShortUniqueId.instantiate(argOptions);
}
