...
test('[Positive] It can verify credential with a valid JWT body and verifyStatus=true query parameter', async ({
	request,
}) => {
	const json = JSON.parse(fs.readFileSync(`${GENERATED_PATH.CREDENTIAL}/valid_credential.json`, 'utf-8'));
...
test('[Positive] It can verify credential with a valid credential body and verifyStatus=true query parameter', async ({
	request,
}) => {
	const json = JSON.parse(fs.readFileSync(`${GENERATED_PATH.CREDENTIAL}/valid_credential.json`, 'utf-8'));
	const response = await request.post('/credential/verify?verifyStatus=true', {
...
test('[Positive] It can verify credential with a valid JWT body and fetchRemoteContexts=true query parameter', async ({
	request,
}) => {
	const json = JSON.parse(fs.readFileSync(`${GENERATED_PATH.CREDENTIAL}/valid_credential.json`, 'utf-8'));
...
test('[Positive] It can verify credential with a valid credential body and fetchRemoteContexts=true query parameter', async ({
	request,
}) => {
	const json = JSON.parse(fs.readFileSync(`${GENERATED_PATH.CREDENTIAL}/valid_credential.json`, 'utf-8'));
	const response = await request.post('/credential/verify?fetchRemoteContexts=true', {
...
test('[Positive] It can verify credential with a valid JWT body, verifyStatus=true, and fetchRemoteContexts=true query parameter', async ({
	request,
}) => {
	const json = JSON.parse(fs.readFileSync(`${GENERATED_PATH.CREDENTIAL}/valid_credential.json`, 'utf-8'));
...
test('[Positive] It can verify credential with a valid credential body, verifyStatus=true, and fetchRemoteContexts=true query parameter', async ({
	request,
}) => {
	const json = JSON.parse(fs.readFileSync(`${GENERATED_PATH.CREDENTIAL}/valid_credential.json`, 'utf-8'));
	const response = await request.post('/credential/verify?verifyStatus=true&fetchRemoteContexts=true', {
...
test('[Negative] It cannot verify credential with an invalid credential body where credential and JWT are different', async ({
	request,
}) => {
