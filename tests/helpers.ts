import { DEFAULT_STATUS_LIST_ENCRYPTED_NAME, DEFAULT_STATUS_LIST_INDICES, DEFAULT_STATUS_LIST_PAYMENT_ADDRESS, DEFAULT_SUBJECT_DID, DEFAULT_SYMMETRIC_KEY, DEFAULT_TESTNET_DID } from "./constants";
...
export const buildUpdateSimpleDID = (did=DEFAULT_TESTNET_DID, pubkey="BTJiso1S4iSiReP6wGksSneGfiKHxz9SYcm2KknpqBJt") => {
    return {
        did: did,
        service: [
            {
