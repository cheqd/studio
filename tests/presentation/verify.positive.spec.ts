...
//         makeFeePayments: true`, async ({
//             request
//         }) => {
//             const verifyRequest = JSON.parse(fs.readFileSync(`${PAYLOADS_BASE_PATH}/verify-positive-${presentationType}-encrypted.json`, 'utf-8'));
...
//             VerifyStatus: ${verifyStatus}, 
//             makeFeePayments: ${makeFeePayments}`, async ({
//                 request
//             }) => {
//                 const verifyRequest = JSON.parse(fs.readFileSync(`${PAYLOADS_BASE_PATH}/verify-positive-${presentationType}-unencrypted.json`, 'utf-8'));
