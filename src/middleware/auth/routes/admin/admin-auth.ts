...
export class AdminHandler extends BaseAuthHandler {
	constructor() {
		...
		// Subscriptions
		this.registerRoute('/admin/subscription/list', 'GET', 'admin:subscription:list:testnet', { skipNamespace: true});
		this.registerRoute('/admin/subscription/list', 'GET', 'admin:subscription:list:mainnet', { skipNamespace: true});
