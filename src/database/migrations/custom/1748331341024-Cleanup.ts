...
export class Cleanup1748331341024 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DELETE FROM "service" WHERE "identifierDid" IS NOT NULL AND "identifierDid" NOT IN (SELECT "did" FROM "identifier");`) // Drop rows without identifierDid records 
        ...
        await queryRunner.query(`ALTER TABLE "resource" ALTER COLUMN "previousVersionId" TYPE uuid USING NULLIF(TRIM("previousVersionId"), '')::uuid;`)
        await queryRunner.query(`ALTER TABLE "resource" ALTER COLUMN "nextVersionId" TYPE uuid USING NULLIF(TRIM("nextVersionId"), '')::uuid;`)
        ...
        await queryRunner.query(`ALTER TABLE "payment" ALTER COLUMN "namespace" TYPE "public"."paymentAccount_namespace_enum" USING "namespace"::"public"."paymentAccount_namespace_enum";`);
        // End of custom logic
