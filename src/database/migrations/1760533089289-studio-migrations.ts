...
export class StudioMigrations1760533089289 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "issuedCredential" ("issuedCredentialId" character varying NOT NULL, "providerId" character varying NOT NULL, "providerCredentialId" character varying, "issuerId" character varying, "subjectId" character varying, "format" text NOT NULL, "category" text NOT NULL, "type" json NOT NULL, "status" text NOT NULL DEFAULT 'issued', "statusUpdatedAt" TIMESTAMP WITH TIME ZONE, "metadata" json, "credentialStatus" json, "issuedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "expiresAt" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deprecated" boolean NOT NULL DEFAULT false, "customerId" uuid NOT NULL, CONSTRAINT "PK_8c349f31da1e65cb1d2e2d45eed" PRIMARY KEY ("issuedCredentialId"))`
		);
		await queryRunner.query(
