...
export class StudioMigrations1758011998054 implements MigrationInterface {
	name = 'StudioMigrations1758011998054';

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "credentialProvider" ("providerId" character varying NOT NULL, "name" character varying NOT NULL, "description" text, "providerType" character varying NOT NULL, "supportedFormats" json NOT NULL DEFAULT '[]', "supportedProtocols" json NOT NULL DEFAULT '[]', "metadata" json NOT NULL, "deprecated" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_ec7823cec7e4cff1ac995b17ef2" PRIMARY KEY ("providerId"))`
		);
		await queryRunner.query(
			`CREATE TABLE "providerConfiguration" ("configId" uuid NOT NULL DEFAULT uuid_generate_v4(), "providerId" character varying NOT NULL, "tenantId" character varying NOT NULL, "encryptedApiKey" text NOT NULL, "apiEndpoint" text NOT NULL, "webhookUrl" text, "validated" boolean NOT NULL DEFAULT false, "validatedAt" TIMESTAMP WITH TIME ZONE, "active" boolean NOT NULL DEFAULT false, "defaultSettings" json, "deprecated" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE, "customerId" uuid NOT NULL, CONSTRAINT "PK_1d01143cbf3d1bd2dea19d96718" PRIMARY KEY ("configId"))`
		);
		await queryRunner.query(
